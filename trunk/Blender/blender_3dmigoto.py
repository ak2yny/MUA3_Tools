# Very important: by DarkStarSword
...
# - Operator to generate vertex group map - Note: Is this useful with a skeleton?
...
#   Note for MUA3: g1m have skeleton, use it instead

import collections, copy, io, itertools, json, numpy, os, re, struct, textwrap
...
# ******************SECTION FOR STUFF THAT MIGHT NOT BE NEEDED*********************
...
def load_3dmigoto_mesh(operator, paths):
    ...
    # For quickly testing how important any unsupported semantics may be:
